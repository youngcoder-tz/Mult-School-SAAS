                ...
                <div class="col-md-12">
                    <div class="customers__area bg-style mb-30">
                        <div class="item-title d-flex justify-content-between">
                            <h2>{{ __('Footer Left Menu List') }}</h2>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                <a class=" btn-action mr-1 edit" data-item="{{ $menu }}" data-updateurl="{{ route('menu.footer-company.update', @$menu->id) }}"
                                                   data-toggle="tooltip"
                                                   title="Edit">
                                                    <img src="{{asset('admin/images/icons/edit-2.svg')}}" alt="edit">
                                                </a>
                                                <a href="javascript:void(0);" data-url="{{route('menu.footer-company.delete', [$menu->id])}}" class="btn-action delete" title="Delete">
    ...
    <div class="modal fade" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('menu.footer-company.store') }}" method="post">
                    @csrf
